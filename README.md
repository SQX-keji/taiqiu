# 开源说明
开源台球助教系统源码，由于是商业版本版本，目前只开源用户端版本部分模块源码提供学习研究，使用uniapp技术，提供学习使用不可商业，商业使用请联系授权
...
#功能说明
轮播，教练列表、教练详情、下单、助教地址、预约助教、台球厅、我的订单、门店订单、登录等模块提供需要学习的朋友研究学习使用

# 体验方式
体验地址：[https://taiqiuzj.xianmaxiong.com](https://taiqiuzj.xianmaxiong.com)
